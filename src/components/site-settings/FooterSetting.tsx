...
const FooterSetting: FC = () => {
  ...
  const { data, loading, refetch } = useFetchSiteSetting(
    `/api/settings/${db_slug.footer_setting}`
  );
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                label="Descripción pie de página"
            ...
            <FieldArray
              ...
              render={(arrayHelper) => (
                <Fragment>
                  <Grid item xs={12}>
                    <FlexBetween>
                      <H3>Contenido de la segunda columna </H3>
            ...
            <FieldArray
              ...
              render={(arrayHelper) => (
                <Fragment>
                  <Grid item xs={12}>
                    <FlexBetween>
                      <H3>Contenido de la tercera columna</H3>
            ...
            <Grid item xs={12}>
              <H3 mb={3}>Contenido de la cuarta columna </H3>
