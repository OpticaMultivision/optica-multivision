...
const ProductCard: FC<ProductCardProps> = (props) => {
  ...
  const handleRedirectWsp = () => {
    const urlWebWhtsap = `https://wa.me/56932271822?text=Hola,%20%20estoy%20interesad@%20en%20consultar%20por%20${title}`;
      ...
      <ContentWrapper>
        ...
        <FlexItemCenter gap={1}>
          <Paragraph fontWeight="600" color="primary.main">
            ${afterDiscountPrice > 0 ? afterDiscountPrice : ' - '}
          </Paragraph>

          {off !== 0 && (
            <Paragraph color="grey.600" fontWeight="600">
              <del>{price?.toFixed()}</del>
            </Paragraph>
          )}
