...
const AdminDashboard: NextPageWithLayout = () => {
  ...
  const cardList = [
    { title: "Total productos", amount: products.length },
    { title: "Total ordenes", amount: orders.length },
    { title: "Ordenes del día", amount: todaysOrders.length },
  ];
