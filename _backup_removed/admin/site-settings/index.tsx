      ...
      <TabContext value={selectTab}>
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
          <TabList
            ...
            variant="scrollable"
          >
            <Tab label="Generales" value="general" disableRipple />
            <Tab label="Barra superior" value="topbar" disableRipple />
            <Tab label="Pie de página" value="footer" disableRipple />
            {/* <Tab label="Redes sociales" value="social-links" disableRipple /> */}
            <Tab
              label="Banner deslizante"
              value="banner-slider"
              disableRipple
            />
